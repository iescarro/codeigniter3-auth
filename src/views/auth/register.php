  ...
  <div class="register mt-5">
    <div class="card shadow-sm p-2">
      <div class="card-body">
        ...
        <p>
          <?= form_submit('submit', 'Register', 'class="btn btn-outline-secondary"'); ?>
        </p>
        <p>
          Nevermind, I have an account. <?= anchor('auth/login', 'Login'); ?>
        </p>
        <?= form_close(); ?>
      </div>
    </div>
